...
xmmsv_t *xmms_xform_plugin_config_register_value (xmms_xform_plugin_t *xform, const gchar *name, xmmsv_t *default_value, xmms_object_handler_t cb, gpointer userdata);
